...
/// Re-exports the shared domain vocabulary into the stats namespace so module
/// types can be written without a namespace prefix while staying strongly typed.
